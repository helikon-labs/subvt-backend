use crate::plotlib::colors::Color;
use crate::plotlib::components::area::AreaSeries;
use crate::plotlib::components::legend::{LegendEntry, LegendMarkerType};
use crate::plotlib::components::scatter::{MarkerType, PointLabelPosition, ScatterPoint};
use crate::plotlib::components::DatumRepresentation;
use crate::plotlib::views::datum::PointDatum;
use crate::plotlib::views::View;
use crate::plotlib::Scale;
use std::fmt::Display;
