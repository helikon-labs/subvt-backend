use crate::plotlib::components::axis::{AxisLine, AxisTick};
use crate::plotlib::scales::ScaleType;
use crate::plotlib::{Chart, Scale};
...
impl Axis {
    ...
    fn get_axis_length(position: AxisPosition, chart: &Chart) -> isize {
    ...
    fn get_axis_line(position: AxisPosition, chart: &Chart) -> AxisLine {
        match position {
