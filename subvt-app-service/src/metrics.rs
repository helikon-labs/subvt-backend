...
pub fn request_counter() -> IntCounter {
...
pub fn connection_count() -> IntGauge {
...
pub fn response_status_code_counter(status_code: &str) -> IntCounter {
...
pub fn observe_response_time_ms(method: &str, status_code: &str, elapsed_ms: f64) {
