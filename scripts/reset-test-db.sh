...
psql -c "DROP DATABASE IF EXISTS subvt_network_test";
...
psql -c "CREATE DATABASE subvt_network_test;"
psql -c "GRANT ALL PRIVILEGES ON DATABASE subvt_network_test TO subvt;"
