...
(
    ...
    CONSTRAINT extrinsic_heartbeat_fk_block
        FOREIGN KEY (block_hash)
            ...
            ON DELETE CASCADE
            ON UPDATE CASCADE,
    CONSTRAINT extrinsic_heartbeat_fk_validator_account_id
...
CREATE INDEX extrinsic_heartbeat_idx_validator_account_id
    ON extrinsic_heartbeat (validator_account_id);

CREATE INDEX extrinsic_heartbeat_idx_validator_account_id_session_index_is_successful
    ON extrinsic_heartbeat (validator_account_id, session_index, is_successful);