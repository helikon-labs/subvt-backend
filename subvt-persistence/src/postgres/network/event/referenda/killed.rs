...
use subvt_types::app::event::referenda::ReferendumKilledEvent;
...
impl PostgreSQLNetworkStorage {
    pub async fn save_referendum_killed_event(
        ...
        let maybe_result: Option<(i32,)> = sqlx::query_as(
            r#"
            INSERT INTO sub_event_referendum_killed (block_hash, extrinsic_index, event_index, referendum_index, ayes, nays, support)
    ...
    pub async fn get_referendum_killed_events_in_block(
        &self,
        block_hash: &str,
    ) -> anyhow::Result<Vec<ReferendumKilledEvent>> {
        let db_events: Vec<(i32, String, Option<i32>, i32, i32, i64, i64, i64)> = sqlx::query_as(
            ...
            FROM sub_event_referendum_killed
            WHERE block_hash = $1
            ORDER BY "id" ASC
            "#,
        )
        ...
        for db_event in db_events {
            events.push(ReferendumKilledEvent {
    ...
    pub async fn update_referendum_killed_event_nesting_index(
        &self,
        block_hash: &str,
        ...
        sqlx::query(
            r#"
            UPDATE sub_event_referendum_killed
            SET nesting_index = $1
