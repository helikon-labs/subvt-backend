...
(
    ...
    CONSTRAINT sub_telegram_chat_activity_log_fk_chat
...
CREATE INDEX IF NOT EXISTS sub_telegram_chat_activity_log_idx_chat_id
    ON sub_telegram_chat_activity_log (telegram_chat_id);
CREATE INDEX IF NOT EXISTS sub_telegram_chat_activity_log_idx_command
    ON sub_telegram_chat_activity_log (command);
CREATE INDEX IF NOT EXISTS sub_telegram_chat_activity_log_idx_query
