...
CREATE INDEX IF NOT EXISTS sub_onekv_candidate_validity_idx_one_kv_candidate_id
    ON sub_onekv_candidate_validity (onekv_candidate_id);
CREATE INDEX IF NOT EXISTS sub_onekv_candidate_validity_idx_validator_account_id
    ON sub_onekv_candidate_validity (validator_account_id);
CREATE INDEX IF NOT EXISTS sub_onekv_candidate_validity_idx_one_kv_candidate_id_is_valid
