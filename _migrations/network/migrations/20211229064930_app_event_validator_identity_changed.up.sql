...
ALTER TABLE sub_app_event_validator_identity_changed
    ADD CONSTRAINT sub_app_event_validator_identity_changed_fk_validator
    FOREIGN KEY (validator_account_id)
        REFERENCES sub_account (id)
        ON DELETE RESTRICT
        ON UPDATE CASCADE;

CREATE INDEX sub_app_event_validator_identity_changed_idx_validator
