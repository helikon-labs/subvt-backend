...
(
    ...
    CONSTRAINT sub_app_event_validator_inactive_next_session_fk_validator
...
CREATE INDEX IF NOT EXISTS sub_app_event_validator_inactive_next_session_idx_validator
