...
(
    ...
    CONSTRAINT sub_event_rewarded_u_event
...
CREATE INDEX IF NOT EXISTS sub_event_rewarded_idx_block_hash
    ON sub_event_rewarded (block_hash);
CREATE INDEX IF NOT EXISTS sub_event_rewarded_idx_rewardee_account_id
    ON sub_event_rewarded (rewardee_account_id);
CREATE INDEX IF NOT EXISTS sub_event_rewarded_idx_extrinsic_index_block_hash_rewardee
