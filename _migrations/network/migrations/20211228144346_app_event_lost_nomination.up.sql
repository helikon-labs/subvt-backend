...
ALTER TABLE sub_app_event_lost_nomination
    ADD CONSTRAINT sub_app_event_lost_nomination_fk_validator
    FOREIGN KEY (validator_account_id)
        REFERENCES sub_account (id)
        ON DELETE RESTRICT
        ON UPDATE CASCADE;
ALTER TABLE sub_app_event_lost_nomination
    ADD CONSTRAINT sub_app_event_lost_nomination_fk_nominator
