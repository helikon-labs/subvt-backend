...
CREATE INDEX IF NOT EXISTS sub_era_staker_idx_era_index
    ON sub_era_staker (era_index);
CREATE INDEX IF NOT EXISTS sub_era_staker_idx_validator_account_id
    ON sub_era_staker (validator_account_id);
CREATE INDEX IF NOT EXISTS sub_era_staker_idx_nominator_account_id
    ON sub_era_staker (nominator_account_id);
CREATE INDEX IF NOT EXISTS sub_era_staker_idx_era_index_validator_account_id
